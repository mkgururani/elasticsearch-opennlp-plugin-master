...
public class OpenNlpMappingTest {
    ...
    public void setupMapperParser() {
        ...
        mapperParser = new DocumentMapperParser(index, null, analysisService, new PostingsFormatService(index),  null, new SimilarityLookupService(index, ImmutableSettings.Builder.EMPTY_SETTINGS), null);
    ...
    public void testSimpleMappings() throws Exception {
        ...
        org.elasticsearch.index.mapper.ParseContext.Document doc = docMapper.parse(json).rootDoc();
