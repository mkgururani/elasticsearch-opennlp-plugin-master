...
public class OpenNlpMapper implements Mapper {
    ...
    public void parse(ParseContext context) throws IOException {
        ...
        context.createExternalValueContext(content);
        ...
        if (names != null && names.size() > 0) {
            for (String name : names) {
                context.createExternalValueContext(name);
        ...
        if (dates != null && dates.size() > 0) {
            for (String date : dates) {
                context.createExternalValueContext(date);
        ...
        if (locations != null && locations.size() > 0) {
            for (String location : locations) {
                context.createExternalValueContext(location);
